"""
LocoDexBiGrasp: bimanual mobile dexterous grasp command.

Same state machine as :class:`LocoDexGrasp` but issues the dedicated
:class:`BiDexGrasp` atomic skill (paired bimanual dex grasp).
"""
...
class LocoDexBiGrasp(Task):
    """Bimanual loco dex grasp (e.g. lift a bin with both Dex3 hands)."""
