...
class LocoRetractReach(Task):
    """
    LocoRetractReach task for mobile manipulation with retract behavior.
    """
    ...
    def step(self):
        if self.init_count < self.init_limit:
            ...
            self.current_action = ["RetractReach", 0, 0, None, None, None]
            self.last_action = None
