"""Auto-collect entrypoint for the single-arm Fling skill on FlingEnv."""
...
TASK_STRING_DICT = {"Fling": 1.0}


@hydra.main(version_base=None, config_path="../Conf", config_name="fling")
