...
class RetractReach(AtomicSkill):
    """Reach task for mobile manipulation using RetractMoveL.
    ...
    In dual-arm mode, both arms are planned simultaneously via RetractMoveL
    ...
    def update(self, info):
        if self.current_state == "failed":
            ...
            return {
                "atomic_skill_type": "RetractReach",
