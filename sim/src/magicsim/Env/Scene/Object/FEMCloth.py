...
class FEMClothObject:
    ...
    def __init__(
        ...
        if self.color_list:
            ...
            self.visual_material_mdl_folder = inst_visual_material_cfg.get("mdl_folder")
    ...
    def _apply_mdl_material(self, mdl_path: str, mdl_name: str = None):
        """Apply an MDL material to the FEM cloth object.
        ...
        try:
            ...
            # Bind material to the FEM cloth mesh
            mesh_prim_to_bind = prims_utils.get_prim_at_path(self.mesh_prim_path)
            if not mesh_prim_to_bind:
                print(
                    f"Warning: Could not find mesh prim at {self.mesh_prim_path} to bind material."
            ...
            mesh_children = prims_utils.get_prim_children(mesh_prim_to_bind)
            for prim in mesh_children:
    ...
    def _apply_physics_ratio_randomization(self, physics_config):
        ...
        # Randomize fem_config parameters
        ...
        # Randomize physics_material parameters
    ...
    def get_state(self, is_relative: bool = False) -> dict[str, torch.Tensor]:
        ...
        try:
            ...
            # Angular velocity is typically zero for FEM cloth objects (no rigid body rotation)
