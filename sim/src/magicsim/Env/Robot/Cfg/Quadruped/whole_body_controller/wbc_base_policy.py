...
class BaseConfig(ArgsConfig):
    """Base config inherited by all Quadruped control loops"""
...
class WBCPolicy(ABC):
    """Base class for implementing control policies in the Quadruped WBC framework.
    ...
    def reset(self, env_ids=None):
        ...
        Args:
            env_ids: Optional environment IDs to reset
        """
        pass
