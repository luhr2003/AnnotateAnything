...
if TYPE_CHECKING:
    ...
    from magicsim.Env.Robot.Cfg.Humanoid.mdp.agile_wbc_action_cfg import (
...
class AgileBasedLowerBodyAction(ActionTerm):
    ...
    def __init__(self, cfg: AgileBasedLowerBodyActionCfg, env: IsaacRLEnv):
        ...
        # Find joint ids for observation joints (matching agile_locomotion_observation_cfg.py)
    ...
    def get_observation(self) -> torch.Tensor:
        ...
        # Scale joint velocities by 0.1 (as in agile_locomotion_observation_cfg.py)
        joint_vel_rel = joint_vel_rel * 0.1

        # Last action (lower body joint positions from previous step)
        # This is already stored in self._raw_actions which gets updated in process_actions
        last_action = self._raw_actions  # [num_envs, num_lower_body_joints]
    ...
    def process_actions(self, actions: torch.Tensor):
        ...
        actions = self._replace_nan_actions(actions)
