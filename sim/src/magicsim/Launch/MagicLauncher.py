...
# IMPORTANT: pin pip warp-lang (>=1.12) into sys.modules before any
# isaacsim/* import can let Isaac Sim's extscache `omni.warp.core 1.8.2`
# shadow it. See CUROBO_V2_04_ENV_MIGRATION.md §4.
import magicsim._warp_bootstrap  # noqa: F401
