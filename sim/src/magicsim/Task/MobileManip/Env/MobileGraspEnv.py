...
class MobileGraspEnv(GraspEnv):
    """
    Grasp Environment for Mobile Manipulation Tasks.
    Uses ridgebackFranka (mobile base + Franka arm + parallel gripper).
    Inherits from GraspEnv for generic object pose / grasp pose handling.
    """
    ...
    def get_grasp_pose(
        ...
        """Override: default hand_type is None (parallel gripper) for ridgebackFranka."""
    ...
    def get_termination(self):
        ...
        object_z = object_pos[:, 2]
        termination = (distance < 0.3) & (object_z > 0.85)
